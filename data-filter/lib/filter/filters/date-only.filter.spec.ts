...
import { DateOnlyFilter } from "./date-only.filter";

describe("DateOnlyFilter", () => {
    describe("getConfig", () => {
    ...
    describe("getWhereOptions", () => {
        ...
        it("with not equal operator should return a valid filter config", async () => {
            const filter = new DateOnlyFilter({
                attribute: "test"
            });
            const options = await filter.getWhereOptions({
        ...
        it("with greater operator should return a valid filter config", async () => {
            const filter = new DateOnlyFilter({
                attribute: "test"
            });
            const options = await filter.getWhereOptions({
